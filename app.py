...
def send_email_notification(frame, location, object_name):
    try:
        ...
        # Email body
        body1 = "A weapon has been detected at " + location
...
def webcam():
    global cap, capture_screenshot  # Access the cap and capture_screenshot variables declared outside the function
    ...
    while True:
        if webcam_streaming:
            ...
            # Draw bounding boxes and labels on the frame
                ...
                print(send_email_notification(frame, get_location(), detected_label))
...
@app.route('/start_webcam', methods=['POST', 'GET'])
def start_webcam():
    ...
    return render_template('start_webcam.html', webcam_streaming=webcam_streaming)
